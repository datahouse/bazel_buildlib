...
buildlib_setup(<a href="#buildlib_setup-name">name</a>, <a href="#buildlib_setup-enable_ts">enable_ts</a>, <a href="#buildlib_setup-enable_java">enable_java</a>, <a href="#buildlib_setup-enable_py">enable_py</a>)
</pre>
...
| <a id="buildlib_setup-enable_py"></a>enable_py |  EXPERIMENTAL Whether to enable Python support.   |  `False` |
